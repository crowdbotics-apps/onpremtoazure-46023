"""
Django settings for onpremtoazure_46023 project.
...
ROOT_URLCONF = 'onpremtoazure_46023.urls'
...
WSGI_APPLICATION = 'onpremtoazure_46023.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "onpremtoazure_46023 API",
    "DESCRIPTION": "API documentation for onpremtoazure_46023 App",
    "VERSION": "v1",
}
